...
function Properties() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors duration-300">
              ...
              <button
                className={`p-2 rounded-md ${
                  showFilters
                    ...
                    : 'hover:bg-secondary-100 dark:hover:bg-secondary-800 dark:text-secondary-300'
                }`}
      ...
      {/* Filters */}
      {showFilters && (
        <div className="bg-white dark:bg-secondary-900 shadow-md border-t border-secondary-100 dark:border-secondary-700 transition-colors duration-300">
          <div className="container py-6">
            ...
            >
              <Link to={`/properties/${property.id}`}>
                ...
                <div className="p-6">
                  ...
                  {/* Token Details */}
                  <div className="bg-secondary-50 dark:bg-secondary-900/40 rounded-lg p-3 mb-4 transition-colors duration-300">
                    <div className="flex justify-between text-sm">
                      <span className="text-secondary-600 dark:text-secondary-400">
                        Available Tokens
                      </span>
