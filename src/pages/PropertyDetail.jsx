...
function PropertyDetail() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors duration-300">
      {/* Navigation */}
      <div className="bg-white dark:bg-secondary-900 shadow transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-secondary-800 rounded-lg shadow-md dark:shadow-secondary-900/50 p-6 transition-colors duration-300"
            >
              ...
              <div className="bg-secondary-50 dark:bg-secondary-900/40 rounded-lg p-6 mb-6 transition-colors duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-secondary-50 dark:bg-secondary-900/40 rounded-lg p-6 transition-colors duration-300">
